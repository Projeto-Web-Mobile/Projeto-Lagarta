...
🚀 Guia Técnico de Implementação das Páginas
...
Objetivo: Copiar a chave PIX e dar feedback visual ao usuário.
...
- HTML5 Semântico (uso exclusivo de tags como <header>, <nav>, <main>, <section>, <article>, <aside>, <footer>, <dialog>, <details>, <summary>)
- JavaScript Vanilla (ES6+)
- Nenhum uso de IDs ou classes (foco em seletores semânticos e seletores de atributos HTML)
